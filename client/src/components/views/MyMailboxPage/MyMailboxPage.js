  ...
  const mailboxCards = Res.map((mailbox, index) => {
    if (mailbox.mailboxStyle === "1") {
      return (
        <div>
          <a
            href={`/address/${UserId._id}/detail/${mailbox._id}`}
          ...
          >
            <div key={index} style={{ position: "relative" }}>
              ...
              >
                OPEN: {mailbox.calendar[0].year}.{mailbox.calendar[0].month}.
                {mailbox.calendar[0].day}
              </p>
            </div>
          </a>
        </div>
  ...
  const IsAvailable = () => {
    ...
    return (
      <div>
        ...
        <Slider {...settings}>{mailboxCards}</Slider>
        <div
          style={{
            width: "100%",
            display: "inline-flex",
        ...
        >
          <a
            href={`/mailbox/${UserId._id}/delete`}
            style={{ textDecorationLine: "none", color: "#000", width: "30%" }}
          >
            <div
              style={{
                width: "100%",
          ...
          <a
            href={`/mailbox/${UserId._id}/create`}
            style={{ textDecorationLine: "none", color: "#000", width: "30%" }}
          >
            <div
              style={{
